...
function missionCode()
	...
	if (Mission.enemyRecyclerIsAlive) and (Mission.NotAroundBool == false) and not IsBuilding(Mission.enemyRecycler) then -- Destroyed Enemy Recycler.
		ClearObjectives()
	...
	if (Mission.recyclerIsAlive) and (Mission.NotAroundBool == false) and not IsBuilding(Mission.Recycler) then -- Destroyed Recycler.
		ClearObjectives()
