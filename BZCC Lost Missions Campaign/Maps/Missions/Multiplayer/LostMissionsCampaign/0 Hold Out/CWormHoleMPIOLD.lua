...
local Mission = {
   ...
   _text1 = "OBJECTIVE: You and or your crew MUST hold out for 1 hour until Major Manson arrives! - ISDF Human Resources \n\nGreen Squad will periodically help your situation.";
...
function Start()
   ...
   SetObjectiveOn(Mission.Masiker)
...
function GreenSquadDeployment()
   ...
   if (Mission.TurnCounter == SecondsToTurns(1500)) then --- 25 minute
      ...
      StartEmitter(green1, 2)
      SetAnimation(green1, "land", 1)
      print("Green Squad has landed at 25 minutes");;
   end
   ...
   if (Mission.TurnCounter == SecondsToTurns(1800)) then --- 30 minute
      ...
      StartEmitter(green1, 2)
      SetAnimation(green1, "land", 1)
      print("Green Squad has landed at 30 minutes");
   end
   ...
   --Wave 6
   -------
   if (Mission.TurnCounter == SecondsToTurns(2400)) then --- 40 minute
      local green1 = BuildObject("ivdrop_land",15,"landpoint");
      SetAngle(green1, 90)
      StartEmitter(green1, 1)
      StartEmitter(green1, 2)
      SetAnimation(green1, "land", 1)
      print("Green Squad has landed at 40 minutes");
   end
