...
function failConditions()
   ...
   if((Mission.TurnCounter > SecondsToTurns(5)) and (Mission.TurnCounter < SecondsToTurns(1320))  )then
...
function SurvivalLogic()
   ...
   if (Mission.ObjectiveTwo == false) and (math.fmod(Mission.TurnCounter, SecondsToTurns(120)) == 0) then --- 2 minutes
      ...
      for i = 1, AttackUnits  do
         Goto(BuildObject(Mission.CPUTeamRace .. "varch",6, "l1spawn"), "attackrun1");
         Goto(BuildObject(Mission.CPUTeamRace .. "vtank",6, "w1spawn"), "attackrun1");
         Goto(BuildObject(Mission.CPUTeamRace .. "vtank",6, "w2spawn"), "attackrun1");
         print("2 min marker");
      end

      local AttackUnits = 1 --attackrun2
      for i = 1, AttackUnits  do
         Goto(BuildObject(Mission.CPUTeamRace .. "varch",6, "l2spawn"), "attackrun2");
         Goto(BuildObject(Mission.CPUTeamRace .. "vtank",6, "w3spawn"), "attackrun2");
         Goto(BuildObject(Mission.CPUTeamRace .. "vtank",6, "w4spawn"), "attackrun2");
         print("2 min marker");
      end
   ...
   if (Mission.ObjectiveTwo == false) and (math.fmod(Mission.TurnCounter, SecondsToTurns(300)) == 0) then --- 5 minutes
      ...
      for i = 1, AttackUnits  do
         Goto(BuildObject(Mission.CPUTeamRace .. "vtank",6, "w5spawn"), "attackrun3");
         Goto(BuildObject(Mission.CPUTeamRace .. "vwalk",6, "m1spawn"), "attackrun3");
         print("5 min marker");
      end
   end
